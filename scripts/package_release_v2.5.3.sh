#!/bin/bash
# package_release_v2.5.3.sh - 生成 v2.5.3 正式交付包

set -e

echo "=========================================="
echo "🐢 玄武固件扫描器 v2.5.3 - 生成交付包"
echo "=========================================="
echo ""
...
cat > RELEASE_NOTES_v2.5.3.md << 'EOF'
# 玄武固件扫描器 v2.5.3 发布说明
...
echo "  → RELEASE_NOTES_v2.5.3.md 已创建"
...
zip -r "$OUTPUT_DIR/$PACKAGE_NAME" \
    ...
    requirements.txt README.md DEPLOYMENT.md USER_GUIDE.md RELEASE_NOTES_v2.5.3.md \
...
echo "  2. 提交客户复测（VAL-FWSCAN-2026-007）"
echo ""
